    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <a href="tel:<?php echo get_theme_mod('sms_phone_handle'); ?>" class="text-white">
                ...
                <a href="mailto:<?php echo get_theme_mod('sms_email_handle'); ?>" class="text-white">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="position-relative mx-auto" style="max-width: 400px;">
                    ...
                    <button type="button"
                        class="btn sign_up_btn  py-2 position-absolute top-0 end-0 mt-2 me-2">SignUp</button>
                </div>
            </div>
        </div>
    </div>
