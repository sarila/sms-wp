                ...
                <div class="row g-2 pt-2">
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1"
                            src="<?php echo get_template_directory_uri() ?>/includes/assets/img/course-1.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1"
                            src="<?php echo get_template_directory_uri() ?>/includes/assets/img/course-2.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1"
                            src="<?php echo get_template_directory_uri() ?>/includes/assets/img/course-3.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1"
                            src="<?php echo get_template_directory_uri() ?>/includes/assets/img/course-2.jpg" alt="">
