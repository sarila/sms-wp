        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid position-absolute w-100 h-100" src="<?php the_post_thumbnail_url(); ?>" alt=""
                ...
                <div class="team-item bg-light">
                    ...
                    <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
                        <div class="bg-light d-flex justify-content-center pt-2 px-1">
                            ...
                            <a class="btn btn-sm-square btn-primary mx-1" href="<?php the_field('linkedin_link'); ?>"
                                target="_blank"><i class="fab fa-linkedin"></i></a>
                            <?php endif; ?>
                            <?php if (get_field('facebook_link')): ?>

                            <a class="btn btn-sm-square btn-primary mx-1" href="<?php the_field('facebook_link'); ?>"
                                target="_blank"><i class="fab fa-facebook"></i></a>
                            <?php endif; ?>

                            <?php if (get_field('instagram_link')): ?>

                            <a class="btn btn-sm-square btn-primary mx-1" href="<?php the_field('instagram_link'); ?>"
                                target="_blank"><i class="fab fa-instagram"></i></a>
                            <?php endif; ?>

                            <?php if (get_field('twitter_link')): ?>

                            <a class="btn btn-sm-square btn-primary mx-1" href="<?php the_field('twitter_link'); ?>"
